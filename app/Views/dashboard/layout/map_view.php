...
<script>
    ...
    const filterEndpoints = {
        amenity: '/dashboard/map/getAmenitiesList',
        district: '/dashboard/map/getDistricts',
        hospital_type: '/dashboard/map/getHospitalTypes',
        hospital_class: '/dashboard/map/getClasses',
        care_type: '/dashboard/map/getCareTypes'
    };
    ...
    function loadMarkers() {
        ...
        fetch(`/dashboard/map/getMarkers?${query.toString()}`)
        .then(res => {
            if (!res.ok) {
